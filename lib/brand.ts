...
export const brand: Brand = {
  name: "D'Lush Studio",
  shortName: "D'Lush",
  microTag: "LASHES, NAILS, BROWS AND TRAINING",
  description:
    "D'Lush Studio in Accra shapes lashes and brows that look like yours, only better — precise, comfortable and made to hold.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0543327775",
    phoneTel: "+233543327775",
    textPhone: "0543327775",
    textPhoneTel: "+233543327775",
    email: "hello@dlush.test",
    privacyEmail: "privacy@dlush.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@d_lush_studio", icon: "tiktok" },
  ],
  ...
  hero: {
    badge: "Now booking",
    title: "lush lashes,\ntaught and done.\nLashes, nails, brows and training.",
    subtitle:
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "D'Lush Studio exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "D'Lush Studio beauty treatment detail",
      ...
      },
      {
        ...
        alt: "D'Lush Studio self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "D'Lush Studio beauty ritual",
      ...
      },
      {
        ...
        alt: "D'Lush Studio calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "D'Lush Studio relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "D'Lush Studio beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "D'Lush Studio lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "D'Lush Studio mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "D'Lush Studio makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "D'Lush Studio foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@d_lush_studio",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783469749/stage4/spa_dlushstudio/tiktok_0.mp4",
        alt: "D'Lush Studio treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783469752/stage4/spa_dlushstudio/tiktok_1.mp4",
        alt: "D'Lush Studio treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783469755/stage4/spa_dlushstudio/tiktok_2.mp4",
        alt: "D'Lush Studio treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "D'Lush Studio self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "D'Lush Studio studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About D'Lush Studio",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "D'Lush Studio is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0543327775 and text 0543327775 for booking help.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0543327775, text 0543327775, or message @d_lush_studio on Instagram." },
          ...
          { q: "Where are you located?", a: "D'Lush Studio is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "D'Lush Studio (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@dlush.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "D'Lush Studio is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@dlush.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to D'Lush Studio",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0543327775", href: "tel:+233543327775" },
      { label: "Text", value: "0543327775", href: "sms:+233543327775" },
      { label: "Instagram", value: "@d_lush_studio", href: "https://www.tiktok.com/@d_lush_studio" },
    ],
  },
  ...
  footer: {
    blurb:
      "D'Lush Studio in Accra — lashes, nails, brows and training.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@d_lush_studio" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0543327775", href: "tel:+233543327775" },
          { label: "Text 0543327775", href: "sms:+233543327775" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "D'Lush Studio — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
