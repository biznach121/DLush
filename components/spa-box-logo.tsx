...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783469747/stage4/spa_dlushstudio/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="D'Lush Studio - Lashes, nails, brows and training">
        <Image
          src={src}
          alt="D'Lush Studio - Lashes, nails, brows and training"
          fill
